...
class Model {
  ...
  static refreshAttributes() {
    ...
    this.prototype.attributeKeys = Object.keys(this.prototype.rawAttributes);
    this.prototype._isAttribute = _.memoize(key => this.prototype.attributeKeys.indexOf(key) !== -1);
